...
public class AlbumListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<SearchAlbumResponse.ResultBean.AlbumsBean> allIllust;

    public AlbumListAdapter(List<SearchAlbumResponse.ResultBean.AlbumsBean> list, Context context) {
        mContext = context;
